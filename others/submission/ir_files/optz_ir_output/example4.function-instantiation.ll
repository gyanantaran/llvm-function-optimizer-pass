; ModuleID = '../output/optz_bc/example4.function-instantiation.bc'
...
entry:
  ...
  %call1 = call i32 @pow3(i32 %2)
  store i32 %call1, i32* %p3, align 4
  call void @pow4(i32* %p4)
  %3 = load i32* %p4, align 4
  %4 = load i32* %p3, align 4
  %mul = mul nsw i32 4, %4
...
entry:
  ...
  store i32 %x, i32* %x.addr, align 4
  %0 = load i32* %x.addr, align 4
  %call = call i32 @pow3(i32 %0)
  store i32 %call, i32* %p3, align 4
  %1 = load i32* %x.addr, align 4
  %call1 = call i32 @polynomial(i32 %1)
  store i32 %call1, i32* %p, align 4
  %2 = load i32* %p, align 4
  %3 = load i32* %p3, align 4
  %mul = mul nsw i32 8, %3
...
entry:
  ...
  %call1 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @.str2, i32 0, i32 0))
  %1 = load i32* %p, align 4
  call void @print_int(i32 %1)
  %2 = load i32* %a, align 4
  %call2 = call i32 @second_polynomial(i32 %2)
  store i32 %call2, i32* %p, align 4
  %call3 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @.str3, i32 0, i32 0))
...
!1 = metadata !{i32 154011, i32 154023, i32 154049, i32 154067, i32 154097, i32 154123, i32 154145}
