; ModuleID = '../output/optz_bc/example1.hello.bc'
source_filename = "../output/optz_bc/example1.hello.bc"
...
entry:
  ...
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str2, i32 0, i32 0))
...
!1 = !{i32 153545, i32 153557, i32 153583, i32 153601, i32 153631, i32 153657, i32 153679}
