; ModuleID = '../output/optz_bc/example4.hello.bc'
source_filename = "../output/optz_bc/example4.hello.bc"
...
entry:
  ...
  %3 = load i32, i32* %p4, align 4
  %4 = load i32, i32* %p3, align 4
  %mul = mul nsw i32 4, %4
...
entry:
  ...
  %call3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str3, i32 0, i32 0))
...
!1 = !{i32 154011, i32 154023, i32 154049, i32 154067, i32 154097, i32 154123, i32 154145}
