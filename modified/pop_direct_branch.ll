; ModuleID = '../output/optz_bc/pop_direct_branch.hello.bc'
source_filename = "../output/optz_bc/pop_direct_branch.hello.bc"
...
!1 = !{i32 42, i32 54, i32 80, i32 98, i32 128, i32 154, i32 176}
