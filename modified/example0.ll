; ModuleID = '../output/optz_bc/example0.hello.bc'
source_filename = "../output/optz_bc/example0.hello.bc"
...
entry:
  ...
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str2, i32 0, i32 0))
...
!1 = !{i32 153487, i32 153499, i32 153525, i32 153543, i32 153573, i32 153599, i32 153621}
